...
<blockquote> Plus, the main story was surprisingly good, with a lot of amazing quotes from the Travellers in that universe. A bit of existential crisis was the icing on the cake.</blockquote>
<Figure
  path="posts/{slug}"
