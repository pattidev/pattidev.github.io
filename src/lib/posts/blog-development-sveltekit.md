...
<div style="display: grid;place-items: center;margin: 20px auto 0;">
  <a href="https://github.com/matfantinel/matfantinel.github.io" target="_blank" class="button btn-secondary flex-[0_0_160px] sm:flex-[0_0_180px]"><Github />See source code on GitHub</a>
</div>
...
SvelteKit uses filesystem-based routing, which means that anything inside a `routes` folder will be accessible via its own path, without the need of manually declaring routes [^1] .
...
<div style="display: grid;place-items: center; margin: 20px auto 0;">
  <a href="https://github.com/matfantinel/matfantinel.github.io" target="_blank" class="button btn-secondary"><Github />See source code on GitHub</a>
</div>
